...
</br> 2) Open Linux terminal and navigate to the directory with the extracted files
</br> 3) Set the main file as executable: chmod +x wifi_fast
</br> 3) Open the file normally: ./wifi_fast

</br> Another way (downloading building from the source):
</br> 1) download wifi_fast.cpp
</br> 2) open the terminal, navigate to the file and build it using g++
